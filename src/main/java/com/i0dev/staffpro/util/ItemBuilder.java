...
import com.i0dev.staffpro.entity.object.ConfigColorItem;
...
public class ItemBuilder extends ItemStack {
    ...
    public static ItemStack fromConfigColorItem(ConfigColorItem configItem) {
        int red = Integer.valueOf(configItem.colorHex.substring(0, 2), 16);
        int green = Integer.valueOf(configItem.colorHex.substring(2, 4), 16);
        int blue = Integer.valueOf(configItem.colorHex.substring(4, 6), 16);
        return new ItemBuilder(configItem.getMaterial())
                .amount(configItem.getAmount())
                .name(configItem.getDisplayName())
                .lore(configItem.getLore())
